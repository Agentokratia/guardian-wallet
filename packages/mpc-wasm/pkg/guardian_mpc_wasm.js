 ...
 * @returns {Uint8Array}
 */
function combine_key_share(core_key_share, aux_info) {
...
exports.combine_key_share = combine_key_share;
 ...
 * @returns {Uint8Array}
 */
function extract_public_key(key_share_bytes) {
...
exports.extract_public_key = extract_public_key;
 ...
 * @returns {Uint8Array}
 */
function pregenerate_paillier_primes() {
...
exports.pregenerate_paillier_primes = pregenerate_paillier_primes;
 ...
 * @returns {any}
 */
function run_dkg(eid_bytes, n, threshold) {
 ...
 * @returns {any}
 */
function run_dkg_with_primes(eid_bytes, n, threshold, serialized_primes) {
    const ptr0 = passArray8ToWasm0(eid_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.run_dkg_with_primes = run_dkg_with_primes;
 ...
 * @returns {any}
 */
function sign_create_session(core_share, aux_info, message_hash, party_index, parties_at_keygen, eid) {
...
exports.sign_create_session = sign_create_session;
 ...
 * @returns {boolean}
 */
function sign_destroy_session(session_id) {
...
exports.sign_destroy_session = sign_destroy_session;
 ...
 * @returns {any}
 */
function sign_process_round(session_id, incoming_messages) {
    const ptr0 = passStringToWasm0(session_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.sign_process_round = sign_process_round;
...
const wasmPath = `${__dirname}/guardian_mpc_wasm_bg.wasm`;
