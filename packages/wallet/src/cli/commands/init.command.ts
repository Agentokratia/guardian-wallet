...
import ora from 'ora';
import { type TwConfig, configExists, getConfigPath, saveConfig } from '../../lib/config.js';
...
export const initCommand = new Command('init')
	...
	.action(async () => {
		...
		try {
			...
			console.log(
				`${chalk.green('  Run ')}${chalk.bold('guardian status')}${chalk.green(' to verify your connection.\n')}`,
			);
		} catch (error: unknown) {
